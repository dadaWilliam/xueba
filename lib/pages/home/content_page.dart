...
class _ContentPageState extends State<ContentPage> {
  ...
  void initState() {
    ...
    _getNotification(0); //0 unread 1 read
  }
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      onTap: (() {
                        Get.toNamed(RouteHelper.getNotification());
                        // showCustomNoticeSnacker("如错误，请联系管理员!", title: "学霸空间");
                      }),
                      child: unread == 0
                          ? AccountWidgt(
                    ...
                    GestureDetector(
                      onTap: (() {
                        Get.toNamed(RouteHelper.getCollected());
                        // showCustomNoticeSnacker("如错误，请联系管理员!", title: "学霸空间");
                      }),
                      child: AccountWidgt(
                          appIcon: AppIcon(
                    ...
                    GestureDetector(
                      onTap: (() {
                        Get.toNamed(RouteHelper.getwebPage(
                            '${AppConstants.ARTICLE}/?tk=$Token', '文章中心'));
                        print('${AppConstants.ARTICLE}/?tk=$Token');
