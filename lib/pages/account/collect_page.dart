...
class _CollectPageState extends State<CollectPage> {
  ...
  void initState() {
    ...
    // _getUser();
    _getToken();
    Get.find<UserController>().isCollectedUpdate = true;
    _getCollected();
  ...
  _getCollected() async {
    await Get.find<UserController>().getCollected();
  }
              ...
              child: EasyRefresh.builder(
                  ...
                  childBuilder: (context, physics) {
                    return SingleChildScrollView(
                        ...
                        physics: physics,
                        child: GetBuilder<UserController>(builder: (collects) {
                          return collects.isCollectedLoaded
                              ? Column(children: [
                                  collects.collectedList.isEmpty
                                      ? Column(
                                          mainAxisAlignment:
                                      ...
                                      ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          itemCount:
                                              collects.collectedList.length,
                                          itemBuilder: (context, index) {
                                            return GestureDetector(
                                                onTap: (() {
                                                  Get.toNamed(RouteHelper
                                                      .getCollectVideo(index));
                                                  // Get.toNamed(
